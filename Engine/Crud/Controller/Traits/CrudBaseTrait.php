...
trait CrudBaseTrait {
     ...
     * @throws Exception
     */
    protected function convertData(array $data, string $context) : array {
        $accessLevel = ($context === 'update' ? CrudDataAccessLevel::UPDATE : CrudDataAccessLevel::CREATE);

        return $this->filterArrayByModelPropertyMode($data, $this->strictWriteMode, $accessLevel, $context);
    }

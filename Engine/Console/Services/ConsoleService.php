...
namespace Oforge\Engine\Console\Services;
...
use Oforge\Engine\Console\ConsoleStatics;
use Oforge\Engine\Console\Lib\ConsoleRenderer;
use Oforge\Engine\Console\Lib\Input;
use Oforge\Engine\Console\Lib\Monolog\Formatter\ConsoleFormatter;
use Oforge\Engine\Core\Abstracts\AbstractBootstrap;
use Oforge\Engine\Core\Helper\BitmaskHelper;
 ...
 *
 * @package Oforge\Engine\Console\Services
 */
class ConsoleService {
    /**

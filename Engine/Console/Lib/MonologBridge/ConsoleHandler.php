 ...
 *
 * (c) Fabien Potencier <fabien@symfony.com> (oforge adjusted version)
 *
 * For the full copyright and license information, please view the LICENSE
 * file that was distributed with this source code.
 */

namespace Oforge\Engine\Console\Lib\MonologBridge;
...
class ConsoleHandler extends AbstractProcessingHandler {
    ...
    /**
     * @param OutputInterface $output The console output to use (the handler remains disabled when passing null

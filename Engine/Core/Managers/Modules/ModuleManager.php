...
namespace Oforge\Engine\Core\Managers\Modules;

use Doctrine\ORM\EntityRepository;
use Doctrine\ORM\OptimisticLockException;
use Doctrine\ORM\ORMException;
use Oforge\Engine\Core\Abstracts\AbstractBootstrap;
use Oforge\Engine\Core\Bootstrap;
use Oforge\Engine\Core\Exceptions\ConfigElementAlreadyExistException;
use Oforge\Engine\Core\Exceptions\ConfigOptionKeyNotExistException;
use Oforge\Engine\Core\Exceptions\CouldNotInstallModuleException;

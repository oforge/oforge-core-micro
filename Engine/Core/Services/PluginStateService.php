...
use Oforge\Engine\Core\Exceptions\Plugin\CouldNotActivatePluginException;
use Oforge\Engine\Core\Exceptions\Plugin\CouldNotDeactivatePluginException;
use Oforge\Engine\Core\Exceptions\Plugin\CouldNotInstallPluginException;
use Oforge\Engine\Core\Exceptions\Plugin\PluginAlreadyActivatedException;
use Oforge\Engine\Core\Exceptions\Plugin\PluginAlreadyInstalledException;
use Oforge\Engine\Core\Exceptions\Plugin\PluginNotActivatedException;
use Oforge\Engine\Core\Exceptions\Plugin\PluginNotFoundException;
use Oforge\Engine\Core\Exceptions\Plugin\PluginNotInstalledException;
